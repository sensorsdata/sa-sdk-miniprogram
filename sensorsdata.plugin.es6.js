...
sa.store = {
  ...
  getUnionId: function() {
    var obj = {};
    if (this._state.first_id && this._state.distinct_id) {
      obj['login_id'] = this._state.distinct_id;
      obj['anonymous_id'] = this._state.first_id;
    } else {
      obj['anonymous_id'] = this._state.distinct_id;
    }
    return obj;
  },
  getProps: function() {
...
sa.quick = function() {
  ...
  if (arg0 === 'getAnonymousID') {
    if (_.isEmptyObject(sa.store._state)) {
      ...
      return sa.store._state.first_id ? sa.store._state.first_id : sa.store._state.distinct_id;
    }
